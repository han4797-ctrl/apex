...
const i18n = {
  ...
  zh: {
    ...
    "brief.toc.04.t": "采购网络",
    "brief.toc.04.d": "哈萨克斯坦、珀斯、加里曼丹、苏拉威西、巴布亚、刚果（金）/赞比亚",
    ...
    "hero.s3": "韩国",
    "strip.1t": "航行 · 资源",
    "strip.1p": "有色金属 · 渣料 · 浮渣 · 木颗粒 · EN590 · 高岭土",
    "strip.2t": "港口 · 电子",
    ...
    "org.res.t": "资源事业部",
    "org.res.1": "有色金属采购",
    "org.res.2": "渣料 · 浮渣 · 木颗粒 · EN590 · 高岭土",
    "org.res.3": "哈萨克斯坦 · 珀斯 · 加里曼丹 · 苏拉威西 · 巴布亚 · 刚果（金）/赞比亚",
    "org.ops.en": "运营",
    "org.ops.t": "双基地",
    ...
    "prof.lead": "PT. APEX TELCOM INKO 是在印尼签约并执行工作的主体。韩国合作伙伴为 VL M&amp;C · APEX HOLDINGS。我们为有色金属废料、冶炼渣、铝浮渣、工业木颗粒、EN590 柴油及高岭土匹配牌号、质量与物流。",
    ...
    "div.res.t": "资源事业部",
    "div.res.d": "铜废料 · 铝锭 · 铝浮渣 · 锡/镍渣 · 木颗粒 · EN590 柴油 · 高岭土",
    "div.res.a": "查看资源品项",
    ...
    "network.lead": "铝来自哈萨克斯坦与珀斯，木颗粒来自加里曼丹，镍来自苏拉威西，铜来自巴布亚与刚果（金）/赞比亚。EN590 柴油按蔚山卸货询价。港口枢纽为达累斯萨拉姆与雅加达；电子来自深圳。PT. APEX TELCOM INKO 坦格朗为本地主体。韩国合作伙伴为 VL M&amp;C · APEX HOLDINGS。",
    "network.map.alt": "世界地图标注：哈萨克斯坦与珀斯的铝、加里曼丹的木颗粒、苏拉威西的镍、巴布亚与刚果（金）/赞比亚的铜、蔚山的 EN590，以及达累斯萨拉姆、雅加达、深圳、坦格朗与首尔等枢纽",
    ...
    "tab.resource": "资源",
    "tab.resource.sub": "金属 · 渣料 · 浮渣 · 生物质 · 柴油 · 高岭土",
    "tab.electronic": "电子",
    "tab.electronic.sub": "显示屏 · PC · 无人机",
    "tab.luggage": "箱包",
    "tab.luggage.sub": "硬壳箱 · 包袋",
    "panel.res.lead": "从金属原料与冶炼副产品——含铝浮渣——到木颗粒、EN590 柴油与工业高岭土。查看图片与关键规格；目录于询价后发送。",
    ...
    "p.dross.badge.grade": "金属含量",
    "p.dross.badge.type": "白渣 · 黑渣",
    "p.dross.badge.metal": "回收原料",
    "p.dross.badge.src": "熔炼副产品",
    "p.dross.spec.src.v": "熔炼 · 冶炼",
    "p.dross.spec.use.v": "金属回收原料",
    ...
    "p.alu.2": "按规格表匹配",
    "p.dross.t": "铝浮渣",
    "p.dross.d": "铝熔炼与冶炼回收原料。匹配金属铝含量（DR 级）及白渣与黑渣。",
    "p.dross.1": "白渣 / 黑渣 · DR 级",
    "p.dross.2": "按金属 Al 含量分级原料",
    "p.tin.t": "锡渣",
    ...
    "brief.intro": "我们从哈萨克斯坦、澳大利亚、坦桑尼亚、印尼、刚果（金）与赞比亚采购铜废料、铝锭、铝浮渣、锡渣与镍渣、木颗粒、EN590 柴油及高岭土。EN590 按韩国蔚山卸货询价。PT. APEX TELCOM INKO 为本地主体。韩国合作伙伴为 VL M&amp;C · APEX HOLDINGS。价格与库存以询价时的报价与检验为准。",
    "brief.s1": "经营品项",
    "brief.s2": "资源产地",
    "brief.s3": "PT. APEX TELCOM INKO · VL M&amp;C · APEX HOLDINGS",
    "brief.s4": "试运后扩量",
    ...
    "mfr.range.t": "采购范围",
    "mfr.range.res.t": "资源",
    "mfr.range.res.p": "铜废料 · 铝锭 · 铝浮渣 · 锡/镍渣 · 木颗粒 · EN590 柴油 · 高岭土",
    "mfr.range.ele.t": "电子",
