...
const i18n = {
  ko: {
    skip: "본문으로 건너뛰기",
    "brand.tag": "Charting New Origins",
    "nav.about": "회사소개",
    "nav.products": "취급품목",
    "nav.briefing": "보고서",
    "nav.network": "해도",
    ...
    "prof.toc.01.t": "회사 개요",
    "prof.toc.01.d": "APEX·HOLDINGS 이원 실행 구조와 거래 원칙",
    "prof.toc.02.t": "기업 정보",
    ...
    "prof.toc.09.t": "연락처",
    "prof.toc.09.d": "APEX·HOLDINGS 창구와 함께 보면 좋은 자료",
    "brief.toc.01.t": "요약",
    ...
    "nav.contact": "문의",
    "nav.inquiry": "견적 문의",
    "hero.eyebrow": "Voyage · APEX × HOLDINGS",
    "hero.title1": "신대륙을 찾듯",
    ...
    "strip.3t": "현지 · APEX",
    "strip.3p": "탄게랑에서 실행한다",
    "strip.4t": "본국 · HOLDINGS",
    "strip.4p": "한국 업무를 총괄한다",
    "about.eyebrow": "The Company",
    "about.title": "미지의 산지를 찾아,\n현지에서 실행합니다",
    "about.p1": "APEX(PT. APEX TELCOM INKO)는 인도네시아 탄게랑에서 현지 업무를 실행하는 전면 브랜드입니다. 한국 파트너 APEX HOLDINGS는 APEX와 동등한 관계로, 한국에서 진행하는 모든 업무를 총괄합니다. 두 회사가 자원파트와 전자파트를 함께 운영합니다.",
    ...
    "about.pr3t": "이원 실행",
    "about.pr3p": "인도네시아는 APEX, 한국은 APEX HOLDINGS가 총괄합니다.",
    "about.cap": "APEX 탄게랑 현지와 서울 거점을 함께 활용합니다.",
    "about.f1t": "전면",
    "about.f2t": "한국 파트너",
    "about.f3t": "인도네시아",
    "about.f3d": "탄게랑 현지 실행",
    ...
    "org.title": "회사 조직도",
    "org.lead": "APEX를 전면에 두고, APEX HOLDINGS와 동등 파트너로 인도네시아 현지와 한국 업무를 나눕니다.",
    ...
    "prof.lead": "전면 브랜드 APEX가 인도네시아 탄게랑에서 현지 실행하고, 한국 업무는 동등 파트너 APEX HOLDINGS가 총괄합니다. 비철금속 스크랩, 제련 슬래그, 알루미늄 드로스, 산업용 우드펠릿, 카올린을 규격·품질·물류와 함께 맞춥니다.",
    "prof.meta": "2026 · 바이어·파트너 배포용 · Tangerang · Seoul · Dar es Salaam · Jakarta",
    "prof.download": "PDF로 저장",
    "prof.about.kicker": "About",
    "prof.about.t": "회사 소개",
    "prof.about.p": "APEX(PT. APEX TELCOM INKO)는 인도네시아 현지 실행을 맡는 전면 브랜드입니다. 한국 파트너 APEX HOLDINGS는 동등한 관계로 한국에서 진행하는 모든 업무를 총괄합니다. 이 소개서는 자원파트를 대상으로 합니다. 전자파트는 별도 카탈로그로 안내합니다.",
    "prof.about.box": "단순 중개가 아닙니다. 등급·성분·이물을 먼저 맞추고, 인도네시아 현지는 APEX가, 한국 창구·통관·납품은 APEX HOLDINGS가 실행합니다.",
    "prof.th.field": "항목",
    "prof.th.value": "내용",
    "prof.field.name": "상호",
    ...
    "network.lead": "알루미늄은 카자흐스탄과 호주 퍼스, 석탄은 칼리만탄, 니켈은 술라웨시, 구리는 파푸아에서 소싱합니다. 항만 거점은 다르에스살람과 자카르타, 전자기기는 선전, 현지 실행은 APEX 탄게랑, 한국 업무는 APEX HOLDINGS 서울입니다.",
    ...
    "brief.intro": "구리 스크랩, 알루미늄 잉곳, 알루미늄 드로스, 주석·니켈 슬래그, 우드펠릿, 카올린을 카자흐스탄·호주·탄자니아·인도네시아에서 소싱합니다. 인도네시아 현지는 APEX가, 한국 업무는 APEX HOLDINGS가 총괄합니다. 가격·재고는 문의 시점의 오퍼와 검사 결과에 따릅니다.",
    "brief.s1": "취급 품목",
    "brief.s2": "자원 소싱 거점",
    "brief.s3": "APEX · HOLDINGS 이원 운영",
    "brief.s4": "시험 선적 후 확대",
    ...
    "mfr.lead": "APEX는 인도네시아 현지 실행을 맡는 전면 브랜드입니다. 한국 업무는 동등 파트너 APEX HOLDINGS가 총괄합니다. 이 한 장은 전자 제조사와 자원 생산 파트너에게, 견적 전에 협업 구조를 전달하기 위한 자료입니다.",
    "mfr.s1": "자원 취급 품목",
    "mfr.s2": "전자 취급 품목",
    "mfr.s3": "인도네시아 · 한국",
    "mfr.s4": "선적 전 검사",
    ...
    "process.3t": "기항 · 인도",
    "process.3p": "인도네시아 현지 일정은 APEX가, 한국 납품·통관·설치는 APEX HOLDINGS가 맞춥니다.",
    "process.4t": "정박 · 사후",
    "process.4p": "반복 공급은 재고·선적 일정을 함께 맞추고, 전자제품은 A/S 창구를 안내합니다.",
    "contact.eyebrow": "Contact",
    "contact.title": "품목과 수량을\n알려 주세요",
    "contact.lead": "전면 문의는 APEX로 보내 주세요. 한국에서 진행하는 업무는 동등 파트너 APEX HOLDINGS가 총괄합니다. 자원이든 전자기기든, 취급 가능 여부와 대략적인 조건을 빠르게 회신드립니다.",
    ...
    "form.note": "전송 시 APEX 메일 앱이 열립니다. 전면 문의는 APEX, 한국 업무는 APEX HOLDINGS 이메일로 연락해 주세요.",
    ...
    "form.item.other": "기타",
    "footer.blurb": "신대륙을 찾듯 산지를 찾아 나섭니다. 전면은 APEX, 한국 업무는 APEX HOLDINGS가 실행합니다.",
    "footer.explore": "바로가기",
    "footer.contact": "연락처",
    "footer.top": "맨 위로",
    "bgm.play": "배경음악 재생",
  ...
  en: {
    ...
    "prof.toc.01.d": "The APEX·HOLDINGS dual-execution structure and trading principles",
    ...
    "prof.toc.09.d": "APEX and HOLDINGS channels, plus related documents",
    ...
    "strip.4t": "Home · HOLDINGS",
    "strip.4p": "Korea work, overseen",
    "about.eyebrow": "The Company",
    "about.title": "We hunt unknown origins\nand execute on the ground",
    "about.p1": "APEX (PT. APEX TELCOM INKO) is the public-facing brand that executes locally in Tangerang, Indonesia. APEX HOLDINGS is an equal partner and oversees every assignment run in Korea. Together they operate Resources and Electronics.",
    ...
    "about.pr3p": "APEX runs Indonesia; APEX HOLDINGS oversees Korea.",
    "about.cap": "APEX Tangerang and APEX HOLDINGS Seoul work as one line.",
    "about.f1t": "Front",
    ...
    "org.lead": "APEX stays in front. APEX HOLDINGS is an equal partner: Indonesia locally, Korea through APEX HOLDINGS.",
    "org.company.kicker": "Front",
    ...
    "prof.lead": "APEX is the public-facing brand executing in Tangerang, Indonesia. Equal partner APEX HOLDINGS oversees all Korea-side work. We match grade, quality, and logistics for non-ferrous scrap, smelting slag, aluminum dross, industrial wood pellets, and kaolin.",
    ...
    "prof.about.p": "APEX (PT. APEX TELCOM INKO) is the public-facing brand for Indonesia execution. Equal partner APEX HOLDINGS oversees all Korea-side work. This profile covers Resources. Electronics are in a separate catalog.",
    "prof.about.box": "This is not plain brokerage. We match grade first. APEX executes in Indonesia; APEX HOLDINGS runs the Korea desk, customs, and delivery.",
    "prof.th.field": "Item",
    ...
    "network.lead": "Aluminum from Kazakhstan and Perth, coal from Kalimantan, nickel from Sulawesi, and copper from Papua. Port hubs are Dar es Salaam and Jakarta; electronics from Shenzhen. APEX Tangerang executes in Indonesia; APEX HOLDINGS Seoul oversees Korea.",
    ...
    "brief.intro": "We source copper scrap, aluminum ingot, aluminum dross, tin and nickel slag, wood pellets, and kaolin from Kazakhstan, Australia, Tanzania, and Indonesia. APEX executes in Indonesia; APEX HOLDINGS oversees Korea. Price and stock follow the offer and inspection at inquiry.",
    "brief.s1": "Items we handle",
    "brief.s2": "Resource sourcing hubs",
    "brief.s3": "APEX · HOLDINGS two desks",
    ...
    "mfr.lead": "APEX is the public-facing brand that executes in Indonesia. Equal partner APEX HOLDINGS oversees all Korea-side work. This page is for manufacturers — electronics factories and resource producers — before a quotation.",
    ...
    "process.3p": "APEX times Indonesia; APEX HOLDINGS handles Korea delivery, customs, and install.",
    ...
    "contact.lead": "Send front-facing inquiries to APEX. Equal partner APEX HOLDINGS oversees all Korea-side work. Resources or electronics—we reply quickly on availability and outline terms.",
    ...
    "form.note": "This opens an APEX mail draft. Email APEX for front-facing inquiries, or APEX HOLDINGS for Korea work.",
    ...
    "footer.blurb": "We look for origins the way explorers looked for a new world. APEX faces the market; APEX HOLDINGS oversees Korea.",
  ...
  id: {
    ...
    "prof.toc.01.d": "Struktur eksekusi ganda APEX·HOLDINGS dan prinsip perdagangan",
    ...
    "prof.toc.09.d": "Kanal APEX dan HOLDINGS, plus dokumen terkait",
    ...
    "strip.3t": "Pantai · APEX",
    "strip.3p": "Dieksekusi di Tangerang",
    "strip.4t": "Kampung · HOLDINGS",
    "strip.4p": "Mengawasi pekerjaan Korea",
    "about.eyebrow": "The Company",
    "about.title": "Kami mencari asal yang belum dipetakan\ndan mengeksekusi di lapangan",
    "about.p1": "APEX (PT. APEX TELCOM INKO) adalah merek depan yang mengeksekusi secara lokal di Tangerang, Indonesia. APEX HOLDINGS adalah mitra setara dan mengawasi setiap pekerjaan yang berjalan di Korea. Bersama-sama mereka mengoperasikan Sumber Daya dan Elektronik.",
    ...
    "about.pr3t": "Dua meja",
    "about.pr3p": "APEX menjalankan Indonesia; APEX HOLDINGS mengawasi Korea.",
    "about.cap": "APEX Tangerang dan APEX HOLDINGS Seoul bekerja dalam satu jalur.",
    "about.f1t": "Depan",
    ...
    "org.lead": "APEX tetap di depan. APEX HOLDINGS adalah mitra setara: Indonesia secara lokal, Korea melalui APEX HOLDINGS.",
    ...
    "prof.lead": "APEX adalah merek depan yang mengeksekusi di Tangerang, Indonesia. Mitra setara APEX HOLDINGS mengawasi seluruh pekerjaan sisi Korea. Kami menyesuaikan mutu, kualitas, dan logistik untuk skrap non-ferrous, terak peleburan, dross aluminium, pelet kayu industri, dan kaolin.",
    ...
    "prof.about.p": "APEX (PT. APEX TELCOM INKO) adalah merek depan untuk eksekusi Indonesia. Mitra setara APEX HOLDINGS mengawasi seluruh pekerjaan sisi Korea. Profil ini mencakup Sumber Daya. Elektronik ada di katalog terpisah.",
    "prof.about.box": "Bukan sekadar perantara. Mutu diselaraskan lebih dulu. APEX mengeksekusi di Indonesia; APEX HOLDINGS menjalankan meja Korea, bea cukai, dan pengiriman.",
    "prof.th.field": "Butir",
    ...
    "network.lead": "Aluminium dari Kazakhstan dan Perth, batubara dari Kalimantan, nikel dari Sulawesi, dan tembaga dari Papua. Hub pelabuhan di Dar es Salaam dan Jakarta; elektronik dari Shenzhen. APEX Tangerang mengeksekusi di Indonesia; APEX HOLDINGS Seoul mengawasi Korea.",
    ...
    "brief.intro": "Kami mengadakan skrap tembaga, ingot aluminium, dross aluminium, terak timah dan nikel, pelet kayu, dan kaolin dari Kazakhstan, Australia, Tanzania, dan Indonesia. APEX mengeksekusi di Indonesia; APEX HOLDINGS mengawasi Korea. Harga dan stok mengikuti penawaran serta inspeksi pada saat pertanyaan.",
    "brief.s1": "Produk yang kami tangani",
    "brief.s2": "Hub pengadaan sumber daya",
    "brief.s3": "Dua meja APEX · HOLDINGS",
    ...
    "mfr.lead": "APEX adalah merek depan yang mengeksekusi di Indonesia. Mitra setara APEX HOLDINGS mengawasi semua pekerjaan sisi Korea. Halaman ini untuk pabrik — pabrik elektronik dan produsen sumber daya — sebelum penawaran.",
    ...
    "process.3p": "APEX mengatur waktu di Indonesia; APEX HOLDINGS menangani pengiriman Korea, bea cukai, dan instalasi.",
    ...
    "contact.lead": "Kirim pertanyaan depan ke APEX. Mitra setara APEX HOLDINGS mengawasi seluruh pekerjaan sisi Korea. Sumber daya atau elektronik — kami membalas cepat soal ketersediaan dan kerangka syarat.",
    ...
    "form.note": "Ini membuka draf email APEX. Kirim ke APEX untuk pertanyaan depan, atau ke APEX HOLDINGS untuk pekerjaan Korea.",
    ...
    "footer.blurb": "Kami mencari asal seperti mencari benua baru. APEX di depan; APEX HOLDINGS mengawasi pekerjaan Korea.",
