...
const i18n = {
  ko: {
    ...
    "prof.toc.01.t": "회사 개요",
    "prof.toc.01.d": "PT. APEX TELCOM INKO · VL M&amp;C · APEX HOLDINGS 이원 실행 구조와 거래 원칙",
    "prof.toc.02.t": "기업 정보",
    ...
    "prof.toc.09.t": "연락처",
    "prof.toc.09.d": "PT. APEX TELCOM INKO · VL M&amp;C · APEX HOLDINGS 창구와 함께 보면 좋은 자료",
    "brief.toc.01.t": "요약",
    ...
    "about.p1": "PT. APEX TELCOM INKO는 인도네시아 탄게랑에서 현지 업무를 실행하는 전면 브랜드입니다. 한국 파트너 VL M&amp;C · APEX HOLDINGS는 PT. APEX TELCOM INKO와 동등한 관계로, 한국에서 진행하는 모든 업무를 총괄합니다. 두 회사가 자원파트와 전자파트를 함께 운영합니다.",
    ...
    "about.pr3t": "이원 실행",
    "about.pr3p": "인도네시아는 PT. APEX TELCOM INKO, 한국은 VL M&amp;C · APEX HOLDINGS가 총괄합니다.",
    "about.cap": "PT. APEX TELCOM INKO 탄게랑과 VL M&amp;C · APEX HOLDINGS 서울 거점을 함께 활용합니다.",
    "about.f1t": "전면",
    "about.f2t": "한국 파트너",
    "about.f3t": "인도네시아",
    "about.f3d": "탄게랑 현지 실행",
    "about.f4t": "한국",
    "about.f4d": "VL M&amp;C · APEX HOLDINGS가 업무 총괄",
    ...
    "partner.vl.role": "VL M&amp;C · APEX HOLDINGS CO.,LTD. · 한국에서 진행하는 모든 업무 총괄",
    "org.eyebrow": "Organization",
    "org.title": "회사 조직도",
    "org.lead": "PT. APEX TELCOM INKO를 전면에 두고, VL M&amp;C · APEX HOLDINGS와 동등 파트너로 인도네시아 현지와 한국 업무를 나눕니다.",
    ...
    "org.ops.2": "VL M&amp;C · APEX HOLDINGS 한국 총괄",
    ...
    "prof.lead": "전면 브랜드 PT. APEX TELCOM INKO가 인도네시아 탄게랑에서 현지 실행하고, 한국 업무는 동등 파트너 VL M&amp;C · APEX HOLDINGS가 총괄합니다. 비철금속 스크랩, 제련 슬래그, 알루미늄 드로스, 산업용 우드펠릿, 카올린을 규격·품질·물류와 함께 맞춥니다.",
    "prof.meta": "2026 · 바이어·파트너 배포용 · Tangerang · Seoul · Dar es Salaam · Jakarta",
    "prof.download": "PDF로 저장",
    "prof.about.kicker": "About",
    "prof.about.t": "회사 소개",
    "prof.about.p": "PT. APEX TELCOM INKO는 인도네시아 현지 실행을 맡는 전면 브랜드입니다. 한국 파트너 VL M&amp;C · APEX HOLDINGS는 동등한 관계로 한국에서 진행하는 모든 업무를 총괄합니다. 이 소개서는 자원파트를 대상으로 합니다. 전자파트는 별도 카탈로그로 안내합니다.",
    "prof.about.box": "단순 중개가 아닙니다. 등급·성분·이물을 먼저 맞추고, 인도네시아 현지는 PT. APEX TELCOM INKO가, 한국 창구·통관·납품은 VL M&amp;C · APEX HOLDINGS가 실행합니다.",
    "prof.th.field": "항목",
    "prof.th.value": "내용",
    "prof.field.name": "상호",
    ...
    "network.lead": "알루미늄은 카자흐스탄과 호주 퍼스, 석탄은 칼리만탄, 니켈은 술라웨시, 구리는 파푸아에서 소싱합니다. 항만 거점은 다르에스살람과 자카르타, 전자기기는 선전, 현지 실행은 PT. APEX TELCOM INKO 탄게랑, 한국 업무는 VL M&amp;C · APEX HOLDINGS 서울입니다.",
    ...
    "network.korea.desc": "VL M&amp;C · APEX HOLDINGS. 한국 업무 총괄 거점",
    "network.korea.tag": "VL M&amp;C · APEX HOLDINGS",
    ...
    "brief.intro": "구리 스크랩, 알루미늄 잉곳, 알루미늄 드로스, 주석·니켈 슬래그, 우드펠릿, 카올린을 카자흐스탄·호주·탄자니아·인도네시아에서 소싱합니다. 인도네시아 현지는 PT. APEX TELCOM INKO가, 한국 업무는 VL M&amp;C · APEX HOLDINGS가 총괄합니다. 가격·재고는 문의 시점의 오퍼와 검사 결과에 따릅니다.",
    "brief.s1": "취급 품목",
    "brief.s2": "자원 소싱 거점",
    "brief.s3": "PT. APEX TELCOM INKO · VL M&amp;C · APEX HOLDINGS 이원 운영",
    "brief.s4": "시험 선적 후 확대",
    ...
    "mfr.lead": "PT. APEX TELCOM INKO는 인도네시아 현지 실행을 맡는 전면 브랜드입니다. 한국 업무는 동등 파트너 VL M&amp;C · APEX HOLDINGS가 총괄합니다. 이 한 장은 전자 제조사와 자원 생산 파트너에게, 견적 전에 협업 구조를 전달하기 위한 자료입니다.",
    "mfr.s1": "자원 취급 품목",
    "mfr.s2": "전자 취급 품목",
    "mfr.s3": "인도네시아 · 한국",
    "mfr.s4": "선적 전 검사",
    ...
    "process.3t": "기항 · 인도",
    "process.3p": "인도네시아 현지 일정은 PT. APEX TELCOM INKO가, 한국 납품·통관·설치는 VL M&amp;C · APEX HOLDINGS가 맞춥니다.",
    "process.4t": "정박 · 사후",
    "process.4p": "반복 공급은 재고·선적 일정을 함께 맞추고, 전자제품은 A/S 창구를 안내합니다.",
    "contact.eyebrow": "Contact",
    "contact.title": "품목과 수량을\n알려 주세요",
    "contact.lead": "전면 문의는 PT. APEX TELCOM INKO로 보내 주세요. 한국에서 진행하는 업무는 동등 파트너 VL M&amp;C · APEX HOLDINGS가 총괄합니다. 자원이든 전자기기든, 취급 가능 여부와 대략적인 조건을 빠르게 회신드립니다.",
    ...
    "form.note": "전송 시 PT. APEX TELCOM INKO 메일 앱이 열립니다. 전면 문의는 PT. APEX TELCOM INKO, 한국 업무는 VL M&amp;C · APEX HOLDINGS 이메일로 연락해 주세요.",
    ...
    "form.item.other": "기타",
    "footer.blurb": "신대륙을 찾듯 산지를 찾아 나섭니다. 전면은 PT. APEX TELCOM INKO, 한국 업무는 VL M&amp;C · APEX HOLDINGS가 실행합니다.",
    "footer.explore": "바로가기",
    "footer.contact": "연락처",
    "footer.top": "맨 위로",
    "bgm.play": "배경음악 재생",
  ...
  en: {
    ...
    "prof.toc.01.d": "PT. APEX TELCOM INKO · VL M&amp;C · APEX HOLDINGS dual-execution structure and trading principles",
    ...
    "about.p1": "PT. APEX TELCOM INKO is the public-facing brand that executes locally in Tangerang, Indonesia. VL M&amp;C · APEX HOLDINGS is an equal partner and oversees every assignment run in Korea. Together they operate Resources and Electronics.",
    ...
    "about.pr3p": "PT. APEX TELCOM INKO runs Indonesia; VL M&amp;C · APEX HOLDINGS oversees Korea.",
    "about.cap": "PT. APEX TELCOM INKO Tangerang and VL M&amp;C · APEX HOLDINGS Seoul work as one line.",
    "about.f1t": "Front",
    "about.f2t": "Korea partner",
    "about.f3t": "Indonesia",
    "about.f3d": "Tangerang local execution",
    "about.f4t": "Korea",
    "about.f4d": "VL M&amp;C · APEX HOLDINGS oversees Korea work",
    "partner.apex.en": "Indonesia · Front",
    ...
    "partner.vl.role": "VL M&amp;C · APEX HOLDINGS CO.,LTD. · Oversees all Korea-side work",
    "org.eyebrow": "Organization",
    "org.title": "Organization chart",
    "org.lead": "PT. APEX TELCOM INKO stays in front. VL M&amp;C · APEX HOLDINGS is an equal partner: Indonesia locally, Korea through VL M&amp;C · APEX HOLDINGS.",
    "org.company.kicker": "Front",
    ...
    "org.ops.2": "VL M&amp;C · APEX HOLDINGS oversees Korea",
    ...
    "prof.lead": "PT. APEX TELCOM INKO is the public-facing brand executing in Tangerang, Indonesia. Equal partner VL M&amp;C · APEX HOLDINGS oversees all Korea-side work. We match grade, quality, and logistics for non-ferrous scrap, smelting slag, aluminum dross, industrial wood pellets, and kaolin.",
    ...
    "prof.about.p": "PT. APEX TELCOM INKO is the public-facing brand for Indonesia execution. Equal partner VL M&amp;C · APEX HOLDINGS oversees all Korea-side work. This profile covers Resources. Electronics are in a separate catalog.",
    "prof.about.box": "This is not plain brokerage. We match grade first. PT. APEX TELCOM INKO executes in Indonesia; VL M&amp;C · APEX HOLDINGS runs the Korea desk, customs, and delivery.",
    "prof.th.field": "Item",
    ...
    "network.lead": "Aluminum from Kazakhstan and Perth, coal from Kalimantan, nickel from Sulawesi, and copper from Papua. Port hubs are Dar es Salaam and Jakarta; electronics from Shenzhen. PT. APEX TELCOM INKO Tangerang executes in Indonesia; VL M&amp;C · APEX HOLDINGS Seoul oversees Korea.",
    ...
    "network.korea.desc": "VL M&amp;C · APEX HOLDINGS. Oversees all Korea-side work",
    "network.korea.tag": "VL M&amp;C · APEX HOLDINGS",
    "network.legend.korea": "VL M&amp;C · APEX HOLDINGS",
    "network.hub": "PT. APEX TELCOM INKO",
    "track.badge": "Demo",
    ...
    "brief.intro": "We source copper scrap, aluminum ingot, aluminum dross, tin and nickel slag, wood pellets, and kaolin from Kazakhstan, Australia, Tanzania, and Indonesia. PT. APEX TELCOM INKO executes in Indonesia; VL M&amp;C · APEX HOLDINGS oversees Korea. Price and stock follow the offer and inspection at inquiry.",
    "brief.s1": "Items we handle",
    "brief.s2": "Resource sourcing hubs",
    "brief.s3": "PT. APEX TELCOM INKO · VL M&amp;C · APEX HOLDINGS two desks",
    ...
    "mfr.lead": "PT. APEX TELCOM INKO is the public-facing brand that executes in Indonesia. Equal partner VL M&amp;C · APEX HOLDINGS oversees all Korea-side work. This page is for manufacturers — electronics factories and resource producers — before a quotation.",
    ...
    "process.3p": "PT. APEX TELCOM INKO times Indonesia; VL M&amp;C · APEX HOLDINGS handles Korea delivery, customs, and install.",
    ...
    "contact.lead": "Send front-facing inquiries to PT. APEX TELCOM INKO. Equal partner VL M&amp;C · APEX HOLDINGS oversees all Korea-side work. Resources or electronics—we reply quickly on availability and outline terms.",
    ...
    "form.note": "This opens a PT. APEX TELCOM INKO mail draft. Email PT. APEX TELCOM INKO for front-facing inquiries, or VL M&amp;C · APEX HOLDINGS for Korea work.",
    ...
    "footer.blurb": "We look for origins the way explorers looked for a new world. PT. APEX TELCOM INKO faces the market; VL M&amp;C · APEX HOLDINGS oversees Korea.",
  ...
  id: {
    ...
    "prof.toc.01.d": "Struktur eksekusi ganda PT. APEX TELCOM INKO · VL M&amp;C · APEX HOLDINGS dan prinsip perdagangan",
    ...
    "about.p1": "PT. APEX TELCOM INKO adalah merek depan yang mengeksekusi secara lokal di Tangerang, Indonesia. VL M&amp;C · APEX HOLDINGS adalah mitra setara dan mengawasi setiap pekerjaan yang berjalan di Korea. Bersama-sama mereka mengoperasikan Sumber Daya dan Elektronik.",
    ...
    "about.pr3t": "Dua meja",
    "about.pr3p": "PT. APEX TELCOM INKO menjalankan Indonesia; VL M&amp;C · APEX HOLDINGS mengawasi Korea.",
    "about.cap": "PT. APEX TELCOM INKO Tangerang dan VL M&amp;C · APEX HOLDINGS Seoul bekerja dalam satu jalur.",
    "about.f1t": "Depan",
    "about.f2t": "Mitra Korea",
    "about.f3t": "Indonesia",
    "about.f3d": "Eksekusi lokal Tangerang",
    "about.f4t": "Korea",
    "about.f4d": "VL M&amp;C · APEX HOLDINGS mengawasi pekerjaan Korea",
    ...
    "partner.vl.role": "VL M&amp;C · APEX HOLDINGS CO.,LTD. · Mengawasi seluruh pekerjaan sisi Korea",
    "org.eyebrow": "Organisasi",
    "org.title": "Bagan organisasi",
    "org.lead": "PT. APEX TELCOM INKO tetap di depan. VL M&amp;C · APEX HOLDINGS adalah mitra setara: Indonesia secara lokal, Korea melalui VL M&amp;C · APEX HOLDINGS.",
    ...
    "org.ops.2": "VL M&amp;C · APEX HOLDINGS mengawasi Korea",
    ...
    "prof.lead": "PT. APEX TELCOM INKO adalah merek depan yang mengeksekusi di Tangerang, Indonesia. Mitra setara VL M&amp;C · APEX HOLDINGS mengawasi seluruh pekerjaan sisi Korea. Kami menyesuaikan mutu, kualitas, dan logistik untuk skrap non-ferrous, terak peleburan, dross aluminium, pelet kayu industri, dan kaolin.",
    ...
    "prof.about.p": "PT. APEX TELCOM INKO adalah merek depan untuk eksekusi Indonesia. Mitra setara VL M&amp;C · APEX HOLDINGS mengawasi seluruh pekerjaan sisi Korea. Profil ini mencakup Sumber Daya. Elektronik ada di katalog terpisah.",
    "prof.about.box": "Bukan sekadar perantara. Mutu diselaraskan lebih dulu. PT. APEX TELCOM INKO mengeksekusi di Indonesia; VL M&amp;C · APEX HOLDINGS menjalankan meja Korea, bea cukai, dan pengiriman.",
    "prof.th.field": "Butir",
    ...
    "network.lead": "Aluminium dari Kazakhstan dan Perth, batubara dari Kalimantan, nikel dari Sulawesi, dan tembaga dari Papua. Hub pelabuhan di Dar es Salaam dan Jakarta; elektronik dari Shenzhen. PT. APEX TELCOM INKO Tangerang mengeksekusi di Indonesia; VL M&amp;C · APEX HOLDINGS Seoul mengawasi Korea.",
    ...
    "network.korea": "Seoul",
    "network.korea.country": "Korea",
    "network.korea.desc": "VL M&amp;C · APEX HOLDINGS. Mengawasi seluruh pekerjaan sisi Korea",
    "network.korea.tag": "VL M&amp;C · APEX HOLDINGS",
    "network.legend.korea": "VL M&amp;C · APEX HOLDINGS",
    "network.hub": "PT. APEX TELCOM INKO",
    "track.badge": "Demo",
    ...
    "brief.intro": "Kami mengadakan skrap tembaga, ingot aluminium, dross aluminium, terak timah dan nikel, pelet kayu, dan kaolin dari Kazakhstan, Australia, Tanzania, dan Indonesia. PT. APEX TELCOM INKO mengeksekusi di Indonesia; VL M&amp;C · APEX HOLDINGS mengawasi Korea. Harga dan stok mengikuti penawaran serta inspeksi pada saat pertanyaan.",
    "brief.s1": "Produk yang kami tangani",
    "brief.s2": "Hub pengadaan sumber daya",
    "brief.s3": "Dua meja PT. APEX TELCOM INKO · VL M&amp;C · APEX HOLDINGS",
    ...
    "mfr.lead": "PT. APEX TELCOM INKO adalah merek depan yang mengeksekusi di Indonesia. Mitra setara VL M&amp;C · APEX HOLDINGS mengawasi semua pekerjaan sisi Korea. Halaman ini untuk pabrik — pabrik elektronik dan produsen sumber daya — sebelum penawaran.",
    ...
    "process.3p": "PT. APEX TELCOM INKO mengatur waktu di Indonesia; VL M&amp;C · APEX HOLDINGS menangani pengiriman Korea, bea cukai, dan instalasi.",
    ...
    "contact.lead": "Kirim pertanyaan depan ke PT. APEX TELCOM INKO. Mitra setara VL M&amp;C · APEX HOLDINGS mengawasi seluruh pekerjaan sisi Korea. Sumber daya atau elektronik — kami membalas cepat soal ketersediaan dan kerangka syarat.",
    ...
    "form.note": "Ini membuka draf email PT. APEX TELCOM INKO. Kirim ke PT. APEX TELCOM INKO untuk pertanyaan depan, atau ke VL M&amp;C · APEX HOLDINGS untuk pekerjaan Korea.",
    ...
    "footer.blurb": "Kami mencari asal seperti mencari benua baru. PT. APEX TELCOM INKO di depan; VL M&amp;C · APEX HOLDINGS mengawasi pekerjaan Korea.",
