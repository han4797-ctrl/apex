...
const i18n = {
  ko: {
    ...
    "org.ops.en": "Structure",
    "org.ops.t": "운영 구조",
    "org.ops.1": "PT. APEX TELCOM INKO",
    "org.ops.2": "VL M&amp;C · APEX HOLDINGS",
    ...
    "brief.intro": "구리 스크랩, 구리 정광, 알루미늄 잉곳, 주석·니켈 슬래그, 우드펠릿, EN590 경유, 카올린을 필리핀·카자흐스탄·퍼스·칼리만탄·술라웨시·파푸아·DRC/잠비아에서 소싱합니다. EN590는 한국 하역을 울산 기준으로 문의합니다. 현지 주체는 PT. APEX TELCOM INKO, 한국 파트너는 VL M&amp;C · APEX HOLDINGS입니다. 가격·재고는 문의 시점의 오퍼와 검사 결과에 따릅니다.",
    "brief.s1": "취급 품목",
    "brief.s2": "자원 산지",
  ...
  en: {
    ...
    "prof.tab.kind": "Summary · 9p",
    "brief.tab.kind": "Summary · 7p",
    "mfr.tab.kind": "Full · 1p",
    "prof.toc.kicker": "Contents",
    "prof.toc.t": "Inside the document · 9 pages",
    ...
    "brief.toc.t": "Inside the document · 7 pages",
    ...
    "brief.intro": "We source copper scrap, copper concentrate, aluminum ingot, tin and nickel slag, wood pellets, EN590 diesel, and kaolin from the Philippines, Kazakhstan, Perth, Kalimantan, Sulawesi, Papua, and DRC/Zambia. EN590 is inquired against Ulsan discharge in Korea. PT. APEX TELCOM INKO is the local party. The Korea partner is VL M&amp;C · APEX HOLDINGS. Price and stock follow the offer and inspection at inquiry.",
  ...
  id: {
    ...
    "prof.tab.kind": "Ringkasan · 9 hlm",
    "brief.tab.kind": "Ringkasan · 7 hlm",
    "mfr.tab.kind": "Lengkap · 1 hlm",
    "prof.toc.kicker": "Isi",
    "prof.toc.t": "Isi dokumen · 9 halaman",
    ...
    "brief.toc.t": "Isi dokumen · 7 halaman",
    ...
    "brief.intro": "Kami mengadakan skrap tembaga, konsentrat tembaga, ingot aluminium, terak timah dan nikel, pelet kayu, solar EN590, dan kaolin dari Filipina, Kazakhstan, Perth, Kalimantan, Sulawesi, Papua, dan DRC/Zambia. EN590 ditanyakan dengan bongkar Ulsan di Korea. Pihak lokal adalah PT. APEX TELCOM INKO. Mitra Korea adalah VL M&amp;C · APEX HOLDINGS. Harga dan stok mengikuti penawaran serta inspeksi pada saat pertanyaan.",
  ...
  zh: {
    ...
    "prof.tab.kind": "摘要 · 9页",
    "brief.tab.kind": "摘要 · 7页",
    "mfr.tab.kind": "全文 · 1页",
    "prof.toc.kicker": "目录",
    "prof.toc.t": "内容构成 · 共 9 页",
    "prof.toc.lead": "组织架构、品项详情、采购基地与贸易流程在各页有更详尽的说明。可直接打印交付。",
    "brief.toc.t": "内容构成 · 共 7 页",
    ...
    "brief.intro": "我们从菲律宾、哈萨克斯坦、珀斯、加里曼丹、苏拉威西、巴布亚与刚果（金）/赞比亚采购铜废料、铜精矿、铝锭、锡渣与镍渣、木颗粒、EN590 柴油及高岭土。EN590 按韩国蔚山卸货询价。PT. APEX TELCOM INKO 为本地主体。韩国合作伙伴为 VL M&amp;C · APEX HOLDINGS。价格与库存以询价时的报价与检验为准。",
    "brief.s1": "经营品项",
    "brief.s2": "资源产地",
    "brief.s3": "PT. APEX TELCOM INKO · VL M&amp;C · APEX HOLDINGS",
    "brief.s4": "试运后扩量",
