...
const i18n = {
  ko: {
    ...
    "prof.toc.06.t": "취급 품목",
    "prof.toc.06.d": "7품목 설명·대표 HS·공급 포인트",
    ...
    "brief.toc.04.d": "필리핀·퍼스·칼리만탄·술라웨시·파푸아·DRC/잠비아",
    ...
    "hero.s3": "대한민국",
    "strip.1t": "출항 · 자원",
    "strip.1p": "비철금속 · 구리 정광 · 제련 슬래그 · 우드펠릿 · EN590 · 카올린",
    "strip.2t": "기항 · 전자",
    ...
    "org.res.t": "자원파트",
    "org.res.1": "비철금속 소싱",
    "org.res.2": "구리 정광 · 슬래그 · 우드펠릿 · EN590 · 카올린",
    "org.res.3": "필리핀 · 퍼스 · 칼리만탄 · 술라웨시 · 파푸아 · DRC/잠비아",
    ...
    "prof.lead": "PT. APEX TELCOM INKO가 인도네시아 현지 계약과 진행의 주체입니다. 한국 파트너는 VL M&amp;C · APEX HOLDINGS입니다. 비철금속 스크랩, 구리 정광, 제련 슬래그, 산업용 우드펠릿, EN590 경유, 카올린을 규격·품질·물류와 함께 맞춥니다.",
    ...
    "div.res.t": "자원파트",
    "div.res.d": "구리 스크랩 · 구리 정광 · 주석/니켈 슬래그 · 우드펠릿 · EN590 경유 · 카올린",
    "div.res.a": "자원 품목 보기",
    ...
    "network.lead": "구리 정광은 필리핀, 우드펠릿은 칼리만탄, 니켈은 술라웨시, 구리 스크랩은 파푸아와 DRC·잠비아에서 소싱합니다. EN590 경유는 울산 하역을 기준으로 문의합니다. 항만 거점은 다르에스살람과 자카르타, 퍼스도 자원 거점입니다. 전자기기는 선전, 현지 주체는 PT. APEX TELCOM INKO 탄게랑, 한국 파트너는 VL M&amp;C · APEX HOLDINGS입니다.",
    "network.map.alt": "필리핀 구리 정광, 칼리만탄 우드펠릿, 술라웨시 니켈, 파푸아·DRC/잠비아 구리, 퍼스 자원 거점, 울산 EN590와 다르에스살람·자카르타·선전·탄게랑·서울 거점을 표시한 세계 지도",
    ...
    "network.kazakhstan.desc": "중앙아시아 자원 거점",
    "network.perth": "퍼스",
    "network.perth.country": "호주",
    "network.perth.desc": "서호주 자원 공급 거점",
    ...
    "panel.res.lead": "구리 스크랩·정광부터 제련 슬래그, 우드펠릿·EN590 경유, 산업용 고령토까지. 사진과 핵심 규격을 보고 고르세요. 카탈로그는 문의 후 발송합니다.",
    ...
    "brief.intro": "구리 스크랩, 구리 정광, 주석·니켈 슬래그, 우드펠릿, EN590 경유, 카올린을 필리핀·호주·탄자니아·인도네시아·DRC·잠비아에서 소싱합니다. EN590는 한국 하역을 울산 기준으로 문의합니다. 현지 주체는 PT. APEX TELCOM INKO, 한국 파트너는 VL M&amp;C · APEX HOLDINGS입니다. 가격·재고는 문의 시점의 오퍼와 검사 결과에 따릅니다.",
    "brief.s1": "취급 품목",
    "brief.s2": "자원 산지",
    ...
    "mfr.range.res.p": "구리 스크랩 · 구리 정광 · 주석/니켈 슬래그 · 우드펠릿 · EN590 경유 · 카올린",
  ...
  en: {
    ...
    "prof.toc.06.d": "Seven items with descriptions, HS codes and supply points",
    ...
    "brief.toc.04.d": "Philippines, Perth, Kalimantan, Sulawesi, Papua, DRC/Zambia",
    ...
    "strip.1p": "Non-ferrous · Copper concentrate · Slag · Wood pellets · EN590 · Kaolin",
    ...
    "org.res.2": "Copper concentrate · slag · wood pellets · EN590 · kaolin",
    "org.res.3": "Philippines · Perth · Kalimantan · Sulawesi · Papua · DRC/Zambia",
    "org.ops.en": "Operations",
    "org.ops.t": "Two bases",
    ...
    "prof.lead": "PT. APEX TELCOM INKO is the party that signs and carries out work in Indonesia. The Korea partner is VL M&amp;C · APEX HOLDINGS. We match grade, quality, and logistics for non-ferrous scrap, copper concentrate, smelting slag, industrial wood pellets, EN590 diesel, and kaolin.",
    ...
    "div.res.d": "Copper scrap · Copper concentrate · Tin/Nickel slag · Wood pellets · EN590 diesel · Kaolin",
    ...
    "network.lead": "Copper concentrate from the Philippines; wood pellets from Kalimantan; nickel from Sulawesi; copper scrap from Papua and DRC/Zambia. EN590 diesel is inquired against Ulsan discharge. Port hubs are Dar es Salaam and Jakarta; Perth is a resource hub; electronics from Shenzhen. PT. APEX TELCOM INKO Tangerang is the local party. The Korea partner is VL M&amp;C · APEX HOLDINGS.",
    "network.map.alt": "World map showing copper concentrate in the Philippines, wood pellets in Kalimantan, nickel in Sulawesi, copper in Papua and DRC/Zambia, a resource hub in Perth, EN590 at Ulsan, plus hubs in Dar es Salaam, Jakarta, Shenzhen, Tangerang, and Seoul",
    ...
    "network.kazakhstan.desc": "Central Asian resource hub",
    "network.perth": "Perth",
    "network.perth.country": "Australia",
    "network.perth.desc": "Western Australia resource supply hub",
    ...
    "tab.resource.sub": "Metals · Concentrate · Slag · Biomass · Diesel · Kaolin",
    "tab.electronic": "Electronics",
    "tab.electronic.sub": "Displays · PCs · Drones",
    "tab.luggage": "Luggage",
    "tab.luggage.sub": "Hardcase · Bags",
    "panel.res.lead": "From copper scrap and concentrate to smelting slag, wood pellets, EN590 diesel, and industrial kaolin. Review photos and key specs; catalogs are sent after inquiry.",
    ...
    "brief.intro": "We source copper scrap, copper concentrate, tin and nickel slag, wood pellets, EN590 diesel, and kaolin from the Philippines, Australia, Tanzania, Indonesia, the DRC, and Zambia. EN590 is inquired against Ulsan discharge in Korea. PT. APEX TELCOM INKO is the local party. The Korea partner is VL M&amp;C · APEX HOLDINGS. Price and stock follow the offer and inspection at inquiry.",
    ...
    "mfr.range.res.p": "Copper scrap · Copper concentrate · Tin / nickel slag · Wood pellets · EN590 diesel · Kaolin",
  ...
  id: {
    ...
    "strip.1p": "Non-ferrous · Konsentrat tembaga · Terak · Pelet kayu · EN590 · Kaolin",
    ...
    "org.res.2": "Konsentrat tembaga · terak · pelet kayu · EN590 · kaolin",
    "org.res.3": "Philippines · Perth · Kalimantan · Sulawesi · Papua · DRC/Zambia",
    "org.ops.en": "Operasi",
    "org.ops.t": "Dua basis",
    ...
    "prof.lead": "PT. APEX TELCOM INKO adalah pihak yang menandatangani dan menjalankan pekerjaan di Indonesia. Mitra Korea adalah VL M&amp;C · APEX HOLDINGS. Kami menyesuaikan mutu, kualitas, dan logistik untuk skrap non-ferrous, konsentrat tembaga, terak peleburan, pelet kayu industri, solar EN590, dan kaolin.",
    ...
    "div.res.d": "Skrap tembaga · Konsentrat tembaga · Terak timah/nikel · Pelet kayu · Solar EN590 · Kaolin",
    ...
    "network.lead": "Konsentrat tembaga dari Filipina; pelet kayu dari Kalimantan; nikel dari Sulawesi; skrap tembaga dari Papua serta DRC/Zambia. Solar EN590 ditanyakan dengan bongkar Ulsan. Hub pelabuhan di Dar es Salaam dan Jakarta; Perth adalah hub sumber daya; elektronik dari Shenzhen. PT. APEX TELCOM INKO Tangerang adalah pihak lokal. Mitra Korea adalah VL M&amp;C · APEX HOLDINGS.",
    "network.map.alt": "Peta dunia yang menampilkan konsentrat tembaga di Filipina, pelet kayu di Kalimantan, nikel di Sulawesi, tembaga di Papua dan DRC/Zambia, hub sumber daya di Perth, EN590 di Ulsan, serta hub di Dar es Salaam, Jakarta, Shenzhen, Tangerang, dan Seoul",
    ...
    "network.kazakhstan": "Kazakhstan",
    "network.kazakhstan.country": "Kazakhstan",
    "network.kazakhstan.desc": "Hub sumber daya Asia Tengah",
    "network.perth": "Perth",
    "network.perth.country": "Australia",
    "network.perth.desc": "Hub pasokan sumber daya Australia Barat",
    "network.kalimantan": "Kalimantan",
    "network.kalimantan.country": "Indonesia",
    ...
    "tab.resource.sub": "Logam · Konsentrat · Terak · Biomassa · Solar · Kaolin",
    "tab.electronic": "Elektronik",
    "tab.electronic.sub": "Papan · PC · Drone",
    "tab.luggage": "Koper",
    "tab.luggage.sub": "Hardcase · Tas",
    "panel.res.lead": "Dari skrap dan konsentrat tembaga hingga terak peleburan, pelet kayu, solar EN590, dan kaolin industri. Lihat foto dan spek utama; katalog dikirim setelah pertanyaan.",
    ...
    "brief.intro": "Kami mengadakan skrap tembaga, konsentrat tembaga, terak timah dan nikel, pelet kayu, solar EN590, dan kaolin dari Filipina, Australia, Tanzania, Indonesia, DRC, dan Zambia. EN590 ditanyakan dengan bongkar Ulsan di Korea. Pihak lokal adalah PT. APEX TELCOM INKO. Mitra Korea adalah VL M&amp;C · APEX HOLDINGS. Harga dan stok mengikuti penawaran serta inspeksi pada saat pertanyaan.",
    ...
    "mfr.range.res.p": "Skrap tembaga · konsentrat tembaga · terak timah/nikel · pelet kayu · solar EN590 · kaolin",
  ...
  zh: {
    ...
    "prof.toc.06.t": "产品范围",
    "prof.toc.06.d": "七类品项，含描述、HS 编码与供应点",
    ...
    "brief.toc.04.t": "采购网络",
    "brief.toc.04.d": "菲律宾、珀斯、加里曼丹、苏拉威西、巴布亚、刚果（金）/赞比亚",
    ...
    "hero.s3": "韩国",
    "strip.1t": "航行 · 资源",
    "strip.1p": "有色金属 · 铜精矿 · 渣料 · 木颗粒 · EN590 · 高岭土",
    "strip.2t": "港口 · 电子",
    ...
    "org.res.t": "资源事业部",
    "org.res.1": "有色金属采购",
    "org.res.2": "铜精矿 · 渣料 · 木颗粒 · EN590 · 高岭土",
    "org.res.3": "菲律宾 · 珀斯 · 加里曼丹 · 苏拉威西 · 巴布亚 · 刚果（金）/赞比亚",
    "org.ops.en": "运营",
    "org.ops.t": "双基地",
    ...
    "prof.lead": "PT. APEX TELCOM INKO 是在印尼签约并执行工作的主体。韩国合作伙伴为 VL M&amp;C · APEX HOLDINGS。我们为有色金属废料、铜精矿、冶炼渣、工业木颗粒、EN590 柴油及高岭土匹配牌号、质量与物流。",
    ...
    "div.res.t": "资源事业部",
    "div.res.d": "铜废料 · 铜精矿 · 锡/镍渣 · 木颗粒 · EN590 柴油 · 高岭土",
    "div.res.a": "查看资源品项",
    ...
    "network.lead": "铜精矿来自菲律宾；木颗粒来自加里曼丹；镍来自苏拉威西；铜废料来自巴布亚与刚果（金）/赞比亚。EN590 柴油按蔚山卸货询价。港口枢纽为达累斯萨拉姆与雅加达；珀斯为资源枢纽；电子来自深圳。PT. APEX TELCOM INKO 坦格朗为本地主体。韩国合作伙伴为 VL M&amp;C · APEX HOLDINGS。",
    "network.map.alt": "世界地图标注：菲律宾铜精矿、加里曼丹木颗粒、苏拉威西镍、巴布亚与刚果（金）/赞比亚铜、珀斯资源枢纽、蔚山 EN590，以及达累斯萨拉姆、雅加达、深圳、坦格朗与首尔等枢纽",
    ...
    "network.kazakhstan.desc": "中亚资源枢纽",
    "network.perth": "珀斯",
    "network.perth.country": "澳大利亚",
    "network.perth.desc": "西澳大利亚资源供应枢纽",
    ...
    "tab.resource": "资源",
    "tab.resource.sub": "金属 · 精矿 · 渣料 · 生物质 · 柴油 · 高岭土",
    "tab.electronic": "电子",
    "tab.electronic.sub": "显示屏 · PC · 无人机",
    "tab.luggage": "箱包",
    "tab.luggage.sub": "硬壳箱 · 包袋",
    "panel.res.lead": "从铜废料与铜精矿到冶炼渣、木颗粒、EN590 柴油与工业高岭土。查看图片与关键规格；目录于询价后发送。",
    ...
    "brief.intro": "我们从菲律宾、澳大利亚、坦桑尼亚、印尼、刚果（金）与赞比亚采购铜废料、铜精矿、锡渣与镍渣、木颗粒、EN590 柴油及高岭土。EN590 按韩国蔚山卸货询价。PT. APEX TELCOM INKO 为本地主体。韩国合作伙伴为 VL M&amp;C · APEX HOLDINGS。价格与库存以询价时的报价与检验为准。",
    "brief.s1": "经营品项",
    "brief.s2": "资源产地",
    "brief.s3": "PT. APEX TELCOM INKO · VL M&amp;C · APEX HOLDINGS",
    "brief.s4": "试运后扩量",
    ...
    "mfr.range.t": "采购范围",
    "mfr.range.res.t": "资源",
    "mfr.range.res.p": "铜废料 · 铜精矿 · 锡/镍渣 · 木颗粒 · EN590 柴油 · 高岭土",
    "mfr.range.ele.t": "电子",
