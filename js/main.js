...
const i18n = {
  ko: {
    ...
    "brief.toc.04.d": "카자흐스탄·퍼스·칼리만탄·술라웨시·파푸아·DRC/잠비아",
    ...
    "hero.s3": "대한민국",
    "strip.1t": "출항 · 자원",
    "strip.1p": "비철금속 · 제련 슬래그 · 드로스 · 우드펠릿 · EN590 · 카올린",
    "strip.2t": "기항 · 전자",
    ...
    "org.res.t": "자원파트",
    "org.res.1": "비철금속 소싱",
    "org.res.2": "슬래그 · 드로스 · 우드펠릿 · EN590 · 카올린",
    "org.res.3": "카자흐스탄 · 퍼스 · 칼리만탄 · 술라웨시 · 파푸아 · DRC/잠비아",
    ...
    "prof.lead": "PT. APEX TELCOM INKO가 인도네시아 현지 계약과 진행의 주체입니다. 한국 파트너는 VL M&amp;C · APEX HOLDINGS입니다. 비철금속 스크랩, 제련 슬래그, 알루미늄 드로스, 산업용 우드펠릿, EN590 경유, 카올린을 규격·품질·물류와 함께 맞춥니다.",
    ...
    "div.res.t": "자원파트",
    "div.res.d": "구리 스크랩 · 알루미늄 잉곳 · 알루미늄 드로스 · 주석/니켈 슬래그 · 우드펠릿 · EN590 경유 · 카올린",
    "div.res.a": "자원 품목 보기",
    ...
    "network.lead": "알루미늄은 카자흐스탄과 호주 퍼스, 우드펠릿은 칼리만탄, 니켈은 술라웨시, 구리는 파푸아와 DRC·잠비아에서 소싱합니다. EN590 경유는 울산 하역을 기준으로 문의합니다. 항만 거점은 다르에스살람과 자카르타, 전자기기는 선전, 현지 주체는 PT. APEX TELCOM INKO 탄게랑, 한국 파트너는 VL M&amp;C · APEX HOLDINGS입니다.",
    "network.map.alt": "카자흐스탄·퍼스 알루미늄, 칼리만탄 우드펠릿, 술라웨시 니켈, 파푸아·DRC/잠비아 구리, 울산 EN590와 다르에스살람·자카르타·선전·탄게랑·서울 거점을 표시한 세계 지도",
    ...
    "panel.res.lead": "금속 원료부터 제련 부산물·드로스, 우드펠릿·EN590 경유, 산업용 고령토까지. 사진과 핵심 규격을 보고 고르세요. 카탈로그는 문의 후 발송합니다.",
    ...
    "brief.intro": "구리 스크랩, 알루미늄 잉곳, 알루미늄 드로스, 주석·니켈 슬래그, 우드펠릿, EN590 경유, 카올린을 카자흐스탄·호주·탄자니아·인도네시아·DRC·잠비아에서 소싱합니다. EN590는 한국 하역을 울산 기준으로 문의합니다. 현지 주체는 PT. APEX TELCOM INKO, 한국 파트너는 VL M&amp;C · APEX HOLDINGS입니다. 가격·재고는 문의 시점의 오퍼와 검사 결과에 따릅니다.",
    "brief.s1": "취급 품목",
    "brief.s2": "자원 산지",
    ...
    "mfr.range.res.p": "구리 스크랩 · 알루미늄 잉곳 · 알루미늄 드로스 · 주석/니켈 슬래그 · 우드펠릿 · EN590 경유 · 카올린",
  ...
  en: {
    ...
    "brief.toc.04.d": "Kazakhstan, Perth, Kalimantan, Sulawesi, Papua, DRC/Zambia",
    ...
    "strip.1p": "Non-ferrous · Slag · Dross · Wood pellets · EN590 · Kaolin",
    ...
    "org.res.2": "Slag · dross · wood pellets · EN590 · kaolin",
    "org.res.3": "Kazakhstan · Perth · Kalimantan · Sulawesi · Papua · DRC/Zambia",
    "org.ops.en": "Operations",
    "org.ops.t": "Two bases",
    ...
    "prof.lead": "PT. APEX TELCOM INKO is the party that signs and carries out work in Indonesia. The Korea partner is VL M&amp;C · APEX HOLDINGS. We match grade, quality, and logistics for non-ferrous scrap, smelting slag, aluminum dross, industrial wood pellets, EN590 diesel, and kaolin.",
    ...
    "div.res.d": "Copper scrap · Aluminum ingot · Aluminum dross · Tin/Nickel slag · Wood pellets · EN590 diesel · Kaolin",
    ...
    "network.lead": "Aluminum from Kazakhstan and Perth, wood pellets from Kalimantan, nickel from Sulawesi, and copper from Papua and DRC/Zambia. EN590 diesel is inquired against Ulsan discharge. Port hubs are Dar es Salaam and Jakarta; electronics from Shenzhen. PT. APEX TELCOM INKO Tangerang is the local party. The Korea partner is VL M&amp;C · APEX HOLDINGS.",
    "network.map.alt": "World map showing aluminum in Kazakhstan and Perth, wood pellets in Kalimantan, nickel in Sulawesi, copper in Papua and DRC/Zambia, EN590 at Ulsan, plus hubs in Dar es Salaam, Jakarta, Shenzhen, Tangerang, and Seoul",
    ...
    "tab.resource.sub": "Metals · Slag · Dross · Biomass · Diesel · Kaolin",
    "tab.electronic": "Electronics",
    "tab.electronic.sub": "Displays · PCs · Drones",
    "tab.luggage": "Luggage",
    "tab.luggage.sub": "Hardcase · Bags",
    "panel.res.lead": "From metal feedstock and smelting by-products — including aluminum dross — to wood pellets, EN590 diesel, and industrial kaolin. Review photos and key specs; catalogs are sent after inquiry.",
    ...
    "brief.intro": "We source copper scrap, aluminum ingot, aluminum dross, tin and nickel slag, wood pellets, EN590 diesel, and kaolin from Kazakhstan, Australia, Tanzania, Indonesia, the DRC, and Zambia. EN590 is inquired against Ulsan discharge in Korea. PT. APEX TELCOM INKO is the local party. The Korea partner is VL M&amp;C · APEX HOLDINGS. Price and stock follow the offer and inspection at inquiry.",
    ...
    "mfr.range.res.p": "Copper scrap · Aluminium ingot · Aluminium dross · Tin / nickel slag · Wood pellets · EN590 diesel · Kaolin",
  ...
  id: {
    ...
    "strip.1p": "Non-ferrous · Terak · Dross · Pelet kayu · EN590 · Kaolin",
    ...
    "org.res.2": "Terak · dross · pelet kayu · EN590 · kaolin",
    "org.res.3": "Kazakhstan · Perth · Kalimantan · Sulawesi · Papua · DRC/Zambia",
    "org.ops.en": "Operasi",
    "org.ops.t": "Dua basis",
    ...
    "prof.lead": "PT. APEX TELCOM INKO adalah pihak yang menandatangani dan menjalankan pekerjaan di Indonesia. Mitra Korea adalah VL M&amp;C · APEX HOLDINGS. Kami menyesuaikan mutu, kualitas, dan logistik untuk skrap non-ferrous, terak peleburan, dross aluminium, pelet kayu industri, solar EN590, dan kaolin.",
    ...
    "div.res.d": "Skrap tembaga · Ingot aluminium · Dross aluminium · Terak timah/nikel · Pelet kayu · Solar EN590 · Kaolin",
    ...
    "network.lead": "Aluminium dari Kazakhstan dan Perth, pelet kayu dari Kalimantan, nikel dari Sulawesi, dan tembaga dari Papua serta DRC/Zambia. Solar EN590 ditanyakan dengan bongkar Ulsan. Hub pelabuhan di Dar es Salaam dan Jakarta; elektronik dari Shenzhen. PT. APEX TELCOM INKO Tangerang adalah pihak lokal. Mitra Korea adalah VL M&amp;C · APEX HOLDINGS.",
    "network.map.alt": "Peta dunia yang menampilkan aluminium di Kazakhstan dan Perth, pelet kayu di Kalimantan, nikel di Sulawesi, tembaga di Papua dan DRC/Zambia, EN590 di Ulsan, serta hub di Dar es Salaam, Jakarta, Shenzhen, Tangerang, dan Seoul",
    ...
    "tab.resource.sub": "Logam · Terak · Dross · Biomassa · Solar · Kaolin",
    "tab.electronic": "Elektronik",
    "tab.electronic.sub": "Papan · PC · Drone",
    "tab.luggage": "Koper",
    "tab.luggage.sub": "Hardcase · Tas",
    "panel.res.lead": "Dari bahan baku logam dan produk samping peleburan — termasuk dross aluminium — hingga pelet kayu, solar EN590, dan kaolin industri. Lihat foto dan spek utama; katalog dikirim setelah pertanyaan.",
    ...
    "brief.intro": "Kami mengadakan skrap tembaga, ingot aluminium, dross aluminium, terak timah dan nikel, pelet kayu, solar EN590, dan kaolin dari Kazakhstan, Australia, Tanzania, Indonesia, DRC, dan Zambia. EN590 ditanyakan dengan bongkar Ulsan di Korea. Pihak lokal adalah PT. APEX TELCOM INKO. Mitra Korea adalah VL M&amp;C · APEX HOLDINGS. Harga dan stok mengikuti penawaran serta inspeksi pada saat pertanyaan.",
    ...
    "mfr.range.res.p": "Skrap tembaga · ingot aluminium · dross aluminium · terak timah/nikel · pelet kayu · solar EN590 · kaolin",
