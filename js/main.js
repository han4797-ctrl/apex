...
const i18n = {
  ko: {
    ...
    "prof.sec.lead": "바이어·파트너에게 그대로 보낼 수 있는 두 가지 문서입니다. 여기서는 핵심만 보여 드리고, 전체 내용은 PDF로 받으실 수 있습니다.",
    ...
    "brief.toc.04.d": "다르에스살람·자카르타·탄게랑·인천",
  ...
  en: {
    ...
    "prof.sec.lead": "Two documents you can forward to buyers and partners as they are. The essentials are here; the full text comes as a PDF.",
    ...
    "brief.toc.04.d": "Dar es Salaam, Jakarta, Tangerang, Incheon",
  ...
  id: {
    ...
    "prof.sec.lead": "Dua dokumen yang bisa dikirim langsung ke pembeli dan mitra. Intinya ada di sini; teks lengkapnya dalam PDF.",
    ...
    "hero.eyebrow": "APEX Indonesia · with VL Korea",
    "hero.title1": "Skenario cerdas",
    "hero.title2": "diwujudkan",
    "hero.lead": "<b>Divisi Sumber Daya</b> untuk skrap non-ferrous, terak peleburan, dross aluminium, pelet kayu, dan kaolin, serta <b>Divisi Elektronik</b> untuk papan interaktif, OPS, laptop, tablet, dan drone pertanian. <b>APEX</b> adalah merek depan. APEX mengeksekusi di Indonesia; mitra setara <b>VL M&amp;C</b> mengawasi seluruh pekerjaan di Korea.",
    ...
    "products.lead": "Dua divisi, dua katalog. Gunakan tab di bawah.",
    "network.eyebrow": "Jaringan Global",
    "network.title": "Jaringan pengadaan kami",
    "network.lead": "Sumber daya kami adakan dari Dar es Salaam dan Jakarta, elektronik dari Shenzhen. APEX Tangerang mengeksekusi di Indonesia; VL Incheon mengawasi Korea.",
    "network.map.alt": "Peta dunia yang menampilkan hub sumber daya di Dar es Salaam dan Jakarta, elektronik di Shenzhen, APEX di Tangerang, dan VL di Incheon",
    ...
    "panel.res.lead": "Dari bahan baku logam dan produk samping peleburan — termasuk dross aluminium — hingga bahan bakar yang lebih bersih dan kaolin industri, kami memasok material yang bisa langsung dipakai pabrik.",
    "panel.ele.lead": "Papan interaktif, modul OPS, laptop, tablet, dan drone pertanian untuk sekolah, instansi, kebun, dan perusahaan. Tinjau spek utama di ruang pamer digital, unduh katalog dan lembar spek, lalu minta sampel.",
    ...
    "brief.intro": "Kami mengadakan skrap tembaga, ingot aluminium, dross aluminium, terak timah dan nikel, pelet kayu, dan kaolin dari Tanzania dan Indonesia. APEX mengeksekusi di Indonesia; VL mengawasi Korea. Harga dan stok mengikuti penawaran serta inspeksi pada saat pertanyaan.",
