...
const i18n = {
  ko: {
    ...
    "network.lead": "알루미늄은 카자흐스탄과 호주 퍼스, 우드펠릿은 칼리만탄, 니켈은 술라웨시, 구리는 파푸아와 DRC·잠비아에서 소싱합니다. 항만 거점은 다르에스살람과 자카르타, 전자기기는 선전, 현지 주체는 PT. APEX TELCOM INKO 탄게랑, 한국 파트너는 VL M&amp;C · APEX HOLDINGS입니다.",
    "network.map.alt": "카자흐스탄·퍼스 알루미늄, 칼리만탄 우드펠릿, 술라웨시 니켈, 파푸아·DRC/잠비아 구리와 다르에스살람·자카르타·선전·탄게랑·서울 거점을 표시한 세계 지도",
    ...
    "brief.intro": "구리 스크랩, 알루미늄 잉곳, 알루미늄 드로스, 주석·니켈 슬래그, 우드펠릿, 카올린을 카자흐스탄·호주·탄자니아·인도네시아·DRC·잠비아에서 소싱합니다. 현지 주체는 PT. APEX TELCOM INKO, 한국 파트너는 VL M&amp;C · APEX HOLDINGS입니다. 가격·재고는 문의 시점의 오퍼와 검사 결과에 따릅니다.",
    "brief.s1": "취급 품목",
    "brief.s2": "자원 산지",
  ...
  en: {
    ...
    "network.lead": "Aluminum from Kazakhstan and Perth, wood pellets from Kalimantan, nickel from Sulawesi, and copper from Papua and DRC/Zambia. Port hubs are Dar es Salaam and Jakarta; electronics from Shenzhen. PT. APEX TELCOM INKO Tangerang is the local party. The Korea partner is VL M&amp;C · APEX HOLDINGS.",
    "network.map.alt": "World map showing aluminum in Kazakhstan and Perth, wood pellets in Kalimantan, nickel in Sulawesi, copper in Papua and DRC/Zambia, plus hubs in Dar es Salaam, Jakarta, Shenzhen, Tangerang, and Seoul",
    ...
    "brief.intro": "We source copper scrap, aluminum ingot, aluminum dross, tin and nickel slag, wood pellets, and kaolin from Kazakhstan, Australia, Tanzania, Indonesia, the DRC, and Zambia. PT. APEX TELCOM INKO is the local party. The Korea partner is VL M&amp;C · APEX HOLDINGS. Price and stock follow the offer and inspection at inquiry.",
  ...
  id: {
    ...
    "network.lead": "Aluminium dari Kazakhstan dan Perth, pelet kayu dari Kalimantan, nikel dari Sulawesi, dan tembaga dari Papua serta DRC/Zambia. Hub pelabuhan di Dar es Salaam dan Jakarta; elektronik dari Shenzhen. PT. APEX TELCOM INKO Tangerang adalah pihak lokal. Mitra Korea adalah VL M&amp;C · APEX HOLDINGS.",
    "network.map.alt": "Peta dunia yang menampilkan aluminium di Kazakhstan dan Perth, pelet kayu di Kalimantan, nikel di Sulawesi, tembaga di Papua dan DRC/Zambia, serta hub di Dar es Salaam, Jakarta, Shenzhen, Tangerang, dan Seoul",
    ...
    "brief.intro": "Kami mengadakan skrap tembaga, ingot aluminium, dross aluminium, terak timah dan nikel, pelet kayu, dan kaolin dari Kazakhstan, Australia, Tanzania, Indonesia, DRC, dan Zambia. Pihak lokal adalah PT. APEX TELCOM INKO. Mitra Korea adalah VL M&amp;C · APEX HOLDINGS. Harga dan stok mengikuti penawaran serta inspeksi pada saat pertanyaan.",
