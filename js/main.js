...
const i18n = {
  ko: {
    ...
    "hero.title1": "시나리오를",
    "hero.title2": "실행합니다",
    "hero.lead": "비철금속·슬래그·우드펠릿을 다루는 <b>자원파트</b>와 전자칠판·OPS·노트북·태블릿PC를 공급하는 <b>전자파트</b>. 전면은 <b>APEX</b>입니다. 인도네시아 현지는 APEX가 실행하고, 한국에서 진행하는 모든 업무는 동등 파트너 <b>VL M&C</b>가 총괄합니다.",
    "hero.cta1": "취급 품목 보기",
    "hero.cta2": "견적 상담",
    "hero.s1": "자원파트 · 전자파트",
    "hero.s2": "APEX 탄게랑",
    "hero.s3": "VL 한국 총괄",
    "strip.1t": "자원파트",
    "strip.1p": "비철금속 · 제련 슬래그 · 우드펠릿",
    "strip.2t": "전자파트",
    "strip.2p": "전자칠판 · OPS · 노트북 · 태블릿PC",
    "strip.3t": "APEX 인도네시아",
    "strip.3p": "탄게랑 현지 실행",
    "strip.4t": "VL 한국",
    "strip.4p": "한국 업무 총괄",
    ...
    "prof.lead": "전면 브랜드 APEX가 인도네시아 탄게랑에서 현지 실행하고, 한국 업무는 동등 파트너 VL M&C가 총괄합니다. 비철금속 스크랩, 제련 슬래그, 산업용 우드펠릿을 규격·품질·물류와 함께 맞춥니다.",
    ...
    "prof.hs.note": "HS 코드는 대표 분류입니다. 실제 통관 코드는 성상·가공도·원산지에 따라 사전 확인합니다. 슬래그·스크랩은 수출국 허가와 한국 폐기물·순환자원 해당 여부를 거래 전에 검토합니다.",
    "prof.trade.t": "거래 방식",
    ...
    "prof.ask.1": "품목과 희망 등급 (예: 밀베리, ADC12, Sn 함량, 산업용 펠릿 I등급)",
    ...
    "div.res.t": "자원파트",
    "div.res.d": "구리 스크랩 · 알루미늄 잉곳 · 주석/니켈 슬래그 · 우드펠릿",
    "div.res.a": "자원 품목 보기",
    "div.ele.en": "Electronics Division",
    "div.ele.t": "전자파트",
    "div.ele.d": "전자칠판 · OPS 모듈 · 노트북 · 태블릿PC",
    "div.ele.a": "전자 품목 보기",
    ...
    "network.shenzhen.desc": "전자기기 및 IT 하드웨어 공급 거점",
    ...
    "panel.res.lead": "금속 원료부터 제련 부산물, 친환경 연료까지. 산업 현장에서 바로 쓰이는 자원을 공급합니다.",
    "panel.ele.lead": "전자칠판과 OPS 모듈, 노트북, 태블릿PC를 교육기관·관공서·기업에 공급합니다. 핵심 사양은 디지털 쇼룸에서 확인하고, 카탈로그·기술 명세서를 내려받은 뒤 샘플을 요청할 수 있습니다.",
    "p.copper.t": "구리 스크랩",
    ...
    "brief.intro": "구리 스크랩, 알루미늄 잉곳, 주석·니켈 슬래그, 우드펠릿을 탄자니아·인도네시아에서 소싱합니다. 인도네시아 현지는 APEX가, 한국 업무는 VL이 총괄합니다. 가격·재고는 문의 시점의 오퍼와 검사 결과에 따릅니다.",
    "brief.s1": "취급 품목",
    "brief.s2": "자원 소싱 거점",
    ...
    "form.note": "전송 시 APEX 메일 앱이 열립니다. 인도네시아는 APEX +62 811.850.8131, 한국 업무는 VL 010.9805.5130으로 연락해 주세요.",
  ...
  en: {
    ...
    "hero.lead": "A <b>Resources Division</b> for non-ferrous scrap, smelting slag, and wood pellets, and an <b>Electronics Division</b> for interactive displays, OPS, laptops, and tablets. <b>APEX</b> is the public-facing brand. APEX executes in Indonesia; equal partner <b>VL M&C</b> oversees all Korea-side work.",
    ...
    "strip.1t": "Resources",
    "strip.1p": "Non-ferrous · Slag · Wood pellets",
    "strip.2t": "Electronics",
    "strip.2p": "Displays · OPS · Laptops · Tablets",
    ...
    "prof.lead": "APEX is the public-facing brand executing in Tangerang, Indonesia. Equal partner VL M&C oversees all Korea-side work. We match grade, quality, and logistics for non-ferrous scrap, smelting slag, and industrial wood pellets.",
    ...
    "prof.hs.note": "HS codes are typical classifications. Actual customs codes depend on form, processing, and origin. Slag and scrap are reviewed for export permits and Korean waste/circular-resource status before a deal.",
    ...
    "prof.ask.1": "Item and preferred grade (e.g. millberry, ADC12, Sn content, industrial pellet I-grade)",
    ...
    "div.res.d": "Copper scrap · Aluminum ingot · Tin/Nickel slag · Wood pellets",
    "div.res.a": "View resource items",
    "div.ele.en": "Displays · PCs · Tablets",
    "div.ele.t": "Electronics Division",
    "div.ele.d": "Interactive displays · OPS modules · Laptops · Tablets",
    ...
    "network.shenzhen.desc": "Electronics and IT hardware supply hub",
    ...
    "tab.resource.sub": "Metals · Slag · Biomass",
    "tab.electronic": "Electronics",
    "tab.electronic.sub": "Displays · PCs · Tablets",
    "panel.res.lead": "From metal feedstock and smelting by-products to cleaner fuel, we supply materials that plants can use right away.",
    "panel.ele.lead": "Interactive flat panels, OPS modules, laptops, and tablets for schools, public offices, and companies. Review key specs in the digital showroom, download the catalog and spec sheet, then request a sample.",
    ...
    "brief.intro": "We source copper scrap, aluminum ingot, tin and nickel slag, and wood pellets from Tanzania and Indonesia. APEX executes in Indonesia; VL oversees Korea. Price and stock follow the offer and inspection at inquiry.",
    ...
    "contact.phone.kr": "Korea",
    "contact.phone.id": "Indonesia",
    "contact.email": "Email",
    ...
    "form.note": "This opens an APEX mail draft. Call APEX +62 811.850.8131 in Indonesia, or VL 010.9805.5130 for Korea work.",
