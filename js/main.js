...
const i18n = {
  ko: {
    ...
    "div.lug.t": "여행파트",
    "div.lug.d": "26·18인치 하드케이스 · 여권 가방 · ARMUZNA 배낭 · 출국지 색상 커버",
    "div.lug.a": "캐리어 품목 보기",
    ...
    "panel.lug.lead": "인도네시아 정규 하지 순례객 캐리어 기술사양(2026년 / 1447년)을 기준으로 26·18인치 하드케이스, 여권 가방, ARMUZNA 배낭을 공급합니다. 출국지별 커버 색상과 신원 표기를 맞출 수 있습니다.",
    ...
    "hall.lug.d": "하지용 4종 세트 사양을 기준으로 보고 고르세요. 카탈로그와 견적은 문의 후에 보내 드립니다.",
    "spec.form": "형태",
    "spec.grade": "등급",
    "spec.ctrl": "관리",
    "spec.use": "용도",
    ...
    "p.koper26.d": "깨지기 어려운 ABS 코팅 폴리카보네이트 대형 캐리어입니다. 하지 순례객 위탁 수하물 사양을 기준으로 하며, 폴리에스터 커버와 출국지 색상 라벨을 함께 맞출 수 있습니다.",
    "p.koper26.alt": "26인치 하드케이스 캐리어",
    "p.koper26.alt.cover": "하지·여행용 캐리어 커버 세트",
    ...
    "p.koper26.embark": "커버 후면·수하물 라벨은 출국지(엠바케이션) 색상을 따릅니다.",
    "p.koper26.embark.aria": "출국지별 커버 색상",
    "p.koper26.1": "내부 메시 포켓 · 2.5 cm 탄성 고정끈 · 아세탈 버클",
    "p.koper26.2": "좌측 PP 받침발 4개 · 매립형 손잡이",
    "p.koper26.3": "신원란·로고 부착 위치 포함, 세트 납품 가능",
    "p.koper18.t": "18인치 기내용",
    "p.koper18.d": "기내 반입용 소형 하드케이스입니다. 대형과 같은 ABS 코팅 PC 셸과 사일런트 휠을 쓰며, 2단 실버 트롤리와 출국지 색상 커버를 맞출 수 있습니다.",
    ...
    "p.armuzna.d": "아라파·무즈달리파·미나 이동용 접이식 배낭입니다. 립스톱 원단에 방수·발수 코팅을 하고, 쓰지 않을 때는 앞 포켓에 접어 22.5 × 14 cm 파우치로 넣습니다.",
    ...
    "mfr.range.lug.p": "26·18인치 ABS 코팅 PC 하드케이스 · 여권 가방 · ARMUZNA 배낭 · 출국지 색상 커버",
    "mfr.how.t": "협업 순서",
    "mfr.how.1t": "사양 확정",
  ...
  en: {
    ...
    "org.lug.3": "Hajj spec · embarkation colors",
    "prof.tag": "Company Profile · Resources Division",
    ...
    "div.lug.en": "Luggage · Hajj spec",
    "div.lug.t": "Luggage Division",
    "div.lug.d": "26″ and 18″ hardcases · passport bag · ARMUZNA pack · embarkation-color covers",
    ...
    "panel.lug.lead": "We supply 26″ and 18″ hardcases, a passport bag, and the ARMUZNA pack to the 2026 / 1447 Indonesian regular Hajj pilgrim luggage specification. Covers and labels can follow each embarkation color.",
    "hall.res.kicker": "Resources Digital Showroom",
    ...
    "hall.lug.d": "Review the four-item Hajj-spec set here. Catalogs and quotes are sent after you inquire.",
    "spec.form": "Form",
    "spec.grade": "Grade",
    "spec.ctrl": "Control",
    "spec.use": "Use",
    ...
    "p.koper26.d": "A tough ABS-coated polycarbonate checked suitcase built to the regular Hajj pilgrim luggage spec. Polyester covers and embarkation-color labels can be matched with the set.",
    "p.koper26.alt": "26-inch hardcase spinner suitcase",
    "p.koper26.alt.cover": "Hajj and travel suitcase cover set",
    ...
    "p.koper26.embark": "Cover backs and baggage labels follow each embarkation color.",
    "p.koper26.embark.aria": "Embarkation cover colors",
    "p.koper26.1": "Mesh pocket · 2.5 cm elastic strap · acetal buckle",
    "p.koper26.2": "Four PP feet on the left side · recessed handle",
    "p.koper26.3": "ID panel and logo placement included; set delivery available",
    "p.koper18.t": "18″ cabin trolley",
    "p.koper18.d": "A cabin-size hardcase with the same ABS-coated PC shell and silent wheels as the 26″ unit. Two-stage silver trolley and embarkation-color cover can be matched.",
    ...
    "p.koper18.1": "Same embarkation color system as the 26″ case",
    ...
    "p.armuzna.d": "A foldable pack for Arafah, Muzdalifah, and Mina. Ripstop fabric with waterproof and water-repellent coating; unused, it packs into a 22.5 × 14 cm pouch.",
    ...
    "mfr.range.lug.p": "26″ and 18″ ABS-coated PC hardcases · passport bag · ARMUZNA pack · embarkation-color covers",
    ...
    "form.item.lugset": "Hajj / travel luggage set",
  ...
  id: {
    ...
    "org.lug.3": "Spek haji · warna embarkasi",
    ...
    "div.lug.en": "Koper · Spek haji",
    "div.lug.t": "Divisi Koper",
    "div.lug.d": "Hardcase 26 dan 18 inci · tas paspor · tas ARMUZNA · sarung warna embarkasi",
    ...
    "panel.lug.lead": "Kami memasok hardcase 26 dan 18 inci, tas paspor, dan tas ARMUZNA sesuai spesifikasi koper jamaah haji reguler Indonesia 2026 / 1447. Sarung dan label dapat mengikuti warna embarkasi.",
    "hall.res.kicker": "Resources Digital Showroom",
    ...
    "hall.lug.d": "Tinjau set 4 item spek haji di sini. Katalog dan penawaran dikirim setelah Anda bertanya.",
    "spec.form": "Bentuk",
    "spec.grade": "Mutu",
    "spec.ctrl": "Kendali",
    "spec.use": "Guna",
    ...
    "p.koper26.d": "Koper besar polikarbonat berlapis ABS yang tidak mudah pecah. Dibuat sesuai spek koper jamaah haji reguler, dengan sarung poliester dan label warna embarkasi yang dapat diselaraskan.",
    "p.koper26.alt": "Koper hardcase 26 inci",
    "p.koper26.alt.cover": "Set sarung koper haji dan perjalanan",
    ...
    "p.koper26.embark": "Bagian belakang sarung dan label bagasi mengikuti warna embarkasi.",
    "p.koper26.embark.aria": "Warna sarung per embarkasi",
    "p.koper26.1": "Saku jaring · tali elastis 2,5 cm · gesper asetal",
    "p.koper26.2": "Empat kaki PP di sisi kiri · handle tanam",
    "p.koper26.3": "Panel identitas dan posisi logo termasuk; dapat dikirim sebagai set",
    "p.koper18.t": "Kabin 18 inci",
    "p.koper18.d": "Hardcase kabin dengan cangkang PC berlapis ABS dan roda senyap yang sama. Trolley perak 2 tingkat dan sarung warna embarkasi dapat diselaraskan.",
    ...
    "p.koper18.1": "Sistem warna embarkasi yang sama dengan 26 inci",
    ...
    "p.armuzna.d": "Tas ransel lipat untuk Arafah, Muzdalifah, dan Mina. Kain ripstop dengan lapisan tahan air dan anti air; saat tidak dipakai dilipat ke pouches 22,5 × 14 cm.",
    ...
    "mfr.range.lug.p": "Hardcase ABS coated PC 26 dan 18 inci · tas paspor · tas ARMUZNA · sarung warna embarkasi",
    ...
    "form.item.lugset": "Set koper haji / perjalanan",
